		...
		Pass {
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    u_xlat0.xyz = (-_Color.xyz) + vec3(1.0, 1.0, 1.0);
					    u_xlat1 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat9 = dot(u_xlat1.xyz, vec3(0.298900008, 0.587000012, 0.114));
					    u_xlat2 = (-u_xlat9) + 1.0;
					    ...
					    u_xlat0.xyz = vec3(u_xlat9) * _Color.xyz + u_xlat0.xyz;
					    u_xlat9 = (-_Blend) + 1.0;
					    u_xlat1.xyz = u_xlat1.xyz * vec3(u_xlat9);
					    SV_Target0.w = u_xlat1.w * _Color.w;
					    SV_Target0.xyz = vec3(_Blend) * u_xlat0.xyz + u_xlat1.xyz;
					    return;
					}"
				}
			}
